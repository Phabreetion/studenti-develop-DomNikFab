...
const routes: Routes = [
    ...
    {path: 'esame', loadChildren: './pages/carriera/dettagli-corso/dettagli-corso.module#DettagliCorsoPageModule'},
    {path: 'esame/:id', loadChildren: './pages/carriera/dettagli-corso/dettagli-corso.module#DettagliCorsoPageModule'},
