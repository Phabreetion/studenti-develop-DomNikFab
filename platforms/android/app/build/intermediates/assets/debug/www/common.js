...
/***/ "./src/app/services/esse3.service.ts":
/*!*******************************************!*\
  !*** ./src/app/services/esse3.service.ts ***!
  \*******************************************/
/*! exports provided: Esse3Service */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Esse3Service", function() { return Esse3Service; });
...
/* harmony import */ var _sync_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sync.service */ "./src/app/services/sync.service.ts");
...
var Esse3Service = /** @class */ (function () {
    function Esse3Service(storage, services, sync) {
        this.storage = storage;
        this.services = services;
        this.sync = sync;
        this.baseurl = this.sync.baseurl;
        this.urlPrenotaAppello = this.baseurl + 'prenotaAppello.php';
        this.urlCancellaPrenotazione = this.baseurl + 'cancellaPrenotazione.php';
        this.urlSession = this.baseurl + 'getSession.php';
    }
    Esse3Service.prototype.getUrlPrenotaAppello = function () {
        return this.urlPrenotaAppello;
    };
    Esse3Service.prototype.getUrlCancellaPrenotazione = function () {
        return this.urlCancellaPrenotazione;
    };
    Esse3Service.prototype.getUrlSession = function () {
        return this.urlSession;
    };
    // Sembra non essere mai usata!
    Esse3Service.prototype.getSid = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.storage.get('token').then(function (token) {
                var body;
                var url = _this.getUrlSession();
                body = {
                    token: token,
                };
                _this.services.getJSON(url, body).then(function (json) {
                    var sid = json['sid'];
                    resolve(sid);
                }, function (err) {
                    // TO BE CHECKED!
                    _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(2, url, err);
                });
            }, function (err) {
                // Dovremmo fare redirect a /login
                _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(2, 'Token non presente', err);
            });
        });
    };
    Esse3Service.prototype.prenotaAppello = function (app_id, ad_id, adsce_id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get('token').then(function (token) {
                var url = _this.getUrlPrenotaAppello();
                var body;
    ...
    Esse3Service.prototype.cancellaPrenotazione = function (app_id, ad_id, adsce_id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get('token').then(function (token) {
                var url = _this.getUrlCancellaPrenotazione();
                var body;
                body = {
                    token: token,
                    ad_id: ad_id,
    ...
    Esse3Service.prototype.queryStringTrasporti = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var queryString = '?';
            _this.storage.get('username').then(function (username) {
                ...
                _this.storage.get('token').then(function (token) {
                    ...
                    _this.services.getJSON(url, body).then(function (json) {
                        ...
                        _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(0, queryString, null);
                        resolve(queryString);
                    }, function (err) {
                        // reject();
                        _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(2, 'Errore getJson', err);
                    });
                }, function (err) {
                    // TO BE CHECKED!
                    _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(2, 'Errore', err);
                });
            }, function (err) {
                // TO BE CHECKED!
                _global_data_service__WEBPACK_IMPORTED_MODULE_1__["GlobalDataService"].log(2, 'Errore', err);
    ...
    Esse3Service = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"],
            ...
            _sync_service__WEBPACK_IMPORTED_MODULE_2__["SyncService"]])
    ], Esse3Service);
    return Esse3Service;
}());
