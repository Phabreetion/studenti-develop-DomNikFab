...
\begin{table}[H]
	...
	\begin{tabular}{| p{\useCaseLeft} | p{\useCaseNum} | p{\useCaseTwoCol} | p{\useCaseTwoCol} |}
		...
		\hline
		\textbf{Eccezioni} & \multicolumn{3}{p{\useCaseMulticol} |}{4.1 Aule Unimol non risponde.} \\
		\hline
		\textbf{Condizioni d'uscita} & \multicolumn{3}{p{\useCaseMulticol} |}{Lo Studente visualizza l’orario.} \\
		\hline
	\end{tabular}
...
\subsubsection{Gestione primo avvio} % Didascalia tabella
%\pagebreak
\begin{figure}[H]
	\centering
...
\subsubsection{Modifica orario} % Didascalia tabella
...
\subsubsection{Visualizza orario} % Didascalia tabella
