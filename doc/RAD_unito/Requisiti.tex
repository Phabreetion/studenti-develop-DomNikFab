...
\subsection{Chat (nuova funzionalità)}
\subsubsection{Chat studenti}
Il sistema sarà in grado di mostrare le \emph{chat} con cui è possibile interagire. Le funzionalità saranno: %si può eliminare questa desc e iniziare direttamente con i req?

\paragraph{Requisito 1: selezione\\} %Si può scrivere direttamente "Selezione chat" o solo "Selezione", se non vi cambia i diagrammi? Perchè così è brutto
...
%Inserire a tutti "Il relativo diagramma dei casi d'uso è visibile al punto \ref{diag:nomerequisito}."
...
\\
Il sistema, inoltre, permetterà di: %Che significa? Manca qualcosa? Altrimenti si può togliere
