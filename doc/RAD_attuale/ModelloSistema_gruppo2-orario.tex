...
\begin{figure}
	\centering
	\includegraphics[height=3in]{imgs/file-comuni-ai-gruppi/useCaseEsempio}
...
\subsection{Diagramam di sequenza - Gestione primo avvio} % Didascalia tabella

\begin{figure}
	\centering
	\includegraphics[height=3in,width=5in]{imgs/gruppo2/sequence-orario-primo-avvio.pdf}
	\caption{Inserire descrizione}
	\label{fig:prova}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[height=3in,width=5in]{imgs/file-comuni-ai-gruppi/ActivityDgEsempio}
	\caption{Inserire descrizione}
	\label{fig:prova}
\end{figure}
