...
\section{Attori}
\emph{\textbf{Studente:}} è un iscritto all’\emph{Università degli Studi del Molise} e possiede le credenziali di accesso al portale \emph{“Esse3“} in qualità di \emph{Studente}. Lo\emph{Studente} utilizzerà la funzione chat per facilitare la comunicazione ufficiale con i \emph{docenti} relativi ai corsi dell’anno di appartenenza, potrà inoltre comunicare con gli altri studenti appartenenti al suo stesso anno di corso.\\


\begin{figure}[h]
	\centering
	\includegraphics[width=0.2\textwidth]{imgs/gruppo6/attori/studente.png}
	\caption{Attore: Studente}
	\label{fig:Attore: Studente}	
\end{figure}

\emph{\textbf{Docente:}} è un professore dell’\emph{Università degli Studi del Molise}avente le credenziali di accesso al portale \emph{“Esse3”} in qualità di \emph{Docente} universitario. Il \emph{Docente} utilizzerà la funzione \emph{chat} per comunicare in via ufficiosa con tutti gli \emph{studenti} iscritti ad un corso da lui tenuto, in modo rapido e semplice. Potrà inoltre amministrare le \emph{chat} secondo le sue preferenze, ovvero, creerà o rimuoverà dei canali e aggiungerà o rimuoverà i membri come meglio crede.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.2\textwidth]{imgs/gruppo6/attori/docente.png}
	\caption{Attore: Docente}
	\label{fig:Attore: Docente}	
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.2\textwidth]{imgs/gruppo6/attori/admin.png}
...
\begin{table}
	...
	Il \emph{Docente} che si trova all'interno di un canale di discussione ha la possibilità di aggiungere un nuovo membro ad un canale attraverso il \emph{menù} di modifica che include l'opzione di aggiuta nuovo membro. \\
...
\begin{table}
	...
	Il \emph{Docente} ha la possibilità di silenziare uno \emph{Studente}, nel caso in cui ritenga inappropriati alcuni interventi nel canale di comunicaizone. Per silenziare si intende impedire l'invio di nuovi messaggi ad un determinato \emph{Studente}. \\
...
\newpage
\paragraph{\textbf{CUP1 - \emph{Login}}}
\begin{table}[tb] 
\small % Dimensione testo piccola
\label{CUP1-Login}
...
\paragraph{\textbf{CUP2 - \emph{Logout}}}
\begin{table}[tb]
...
\paragraph{\textbf{CUP3 - Ricerca \emph{chat}}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP4 - Visualizza lista \emph{chat}}}
...
\paragraph{\textbf{CUP5 - Abilita \emph{chat}}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP6 - Disabilita \emph{chat}}}
\begin{table}[tb]
...
\paragraph{\textbf{CUP7 - Visualizza canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP8 - Aggiungi canale}}
\begin{table}[tb]
...
\paragraph{\textbf{CUP9 - Cancella canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP10 - Visualizza lista utenti}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP11 - Aggiungi un utente ad un canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP12 - Rimuovere un utente da un canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP13 - Silenziare utente in un canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP14 - Reintegra utente in un canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP15 - Modificare i permessi di un utente in un canale}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP16 - Nascondi messaggio}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP17 - Reintegra messaggio}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP18 - Invio Notifiche}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small % Dimensione testo piccola
...
\paragraph{\textbf{CUP19 - Gestione messaggi inopportuni}}
\begin{table}[tb]
%\normalsize % Dimensione testo normale
\small
