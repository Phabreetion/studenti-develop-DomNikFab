...
\begin{figure}
	\centering
	\includegraphics[height=3in]{imgs/file-comuni-ai-gruppi/usecasemedia.png}
...
\begin{figure}
	\centering
	\includegraphics[height=3in]{imgs/file-comuni-ai-gruppi/sequencesimulazionemedia.png}
	\caption{sequence simulazione media}
	\label{fig:prova}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=3in]{imgs/file-comuni-ai-gruppi/valorinonvalidi.png}
...
\begin{figure}
	\centering
	\includegraphics[height=5in]{imgs/file-comuni-ai-gruppi/activitydiagramgen.jpeg}
	\caption{Diagramma di attività}
	\label{fig:prova}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=6in]{imgs/file-comuni-ai-gruppi/mockupmenu.png}
	\caption{Mockup Menù}
	\label{fig:prova}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=6in]{imgs/file-comuni-ai-gruppi/mockupselezionaesami.png}
	\caption{Mockup Seleziona esami}
	\label{fig:prova}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=6in]{imgs/file-comuni-ai-gruppi/mockupmedia.png}
	\caption{Mockup Media}
	\label{fig:prova}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=6in]{imgs/file-comuni-ai-gruppi/mockupesamiterminati.png}
	\caption{Mockup Esami terminati}
	\label{fig:prova}
\end{figure}
\clearpage