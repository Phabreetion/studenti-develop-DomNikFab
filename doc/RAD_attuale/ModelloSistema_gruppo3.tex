...
\begin{figure}[H]
	\centering
	\includegraphics[height=4in]{imgs/gruppo3/usecasemedia.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3in]{imgs/gruppo3/sequencesimulazionemedia.png}
	\caption{sequence simulazione media}
	\label{fig:prova}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[height=3in]{imgs/gruppo3/valorinonvalidi.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=5in]{imgs/gruppo3/activitydiagramgen.jpeg}
